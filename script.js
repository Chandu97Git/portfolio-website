...
console.log('%c👋 Hi there, Developer!', 'color: #6366f1; font-size: 20px; font-weight: bold;');
console.log('%cLike what you see? Let\'s connect!', 'color: #64748b; font-size: 14px;');
console.log('%c🔗 LinkedIn: linkedin.com/in/chandu-undurthi', 'color: #6366f1; font-size: 12px;');
console.log('%c🔗 GitHub: github.com/Chandu97Git', 'color: #6366f1; font-size: 12px;');
...
function activateEasterEgg() {
    ...
    setTimeout(() => {
        ...
        alert('🎉 You found the secret! You\'re a true developer!');
    }, 2000);
}
